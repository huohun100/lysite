    ...
    public function category_add()
    {
        ...
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle('新增分类') // 设置页面标题
                ...
                ->addFormItem('list_template', 'select', '列表模版', '文章列表或单页模板', $template_lists)
    ...
    public function category_edit($id)
    {
        ...
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle('编辑分类') // 设置页面标题
                ...
                ->addFormItem('banner', 'picture_temp', 'Banner图片', 'Banner图片', null, array('self' => array('upload_driver' => C('site_config.upload_driver') ?: 'Qiniu')))
                ->addFormItem('list_template', 'text', '列表模版', '文章列表或单页模板', $template_lists)
                ->addFormItem('detail_template', 'text', '详情模版', '文章详情页模版', $template_detail)
