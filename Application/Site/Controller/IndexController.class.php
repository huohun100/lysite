...
class IndexController extends HomeController
{
    ...
    public function index()
    {
        ...
        if (C('CURRENT_THEME')) {
            ...
            $this->assign('theme_path_header', './Theme/' . C('CURRENT_THEME') . '/Site/Site/theme/' . $theme_info['name'] . '/header.html');
            $this->assign('theme_path_footer', './Theme/' . C('CURRENT_THEME') . '/Site/Site/theme/' . $theme_info['name'] . '/footer.html');
            ...
            $this->assign('theme_path_header', './Application/Site/View/Site/theme/' . $theme_info['name'] . '/header.html');
            $this->assign('theme_path_footer', './Application/Site/View/Site/theme/' . $theme_info['name'] . '/footer.html');
            $this->assign('info', $info);
            $this->display('Site/theme/' . $theme_info['name'] . '/index');
        }
    }
    ...
    public function lists($cid)
    {
        ...
        if (C('CURRENT_THEME')) {
            ...
            $this->assign('theme_path_header', './Theme/' . C('CURRENT_THEME') . '/Site/Site/theme/' . $theme_info['name'] . '/header.html');
            $this->assign('theme_path_footer', './Theme/' . C('CURRENT_THEME') . '/Site/Site/theme/' . $theme_info['name'] . '/footer.html');
            $this->display('Site/theme/' . $theme_info['name'] . '/' . ($category_info['list_template'] ?: 'lists_list'));
        } else {
            // 主题目录
            $info['theme_path'] = __ROOT__ . '/Application/Site/View/Site/theme/' . $theme_info['name'];
            $this->assign('info', $info);
    ...
    public function page($cid)
    {
        ...
        if (C('CURRENT_THEME')) {
            ...
            $this->assign('theme_path_header', './Theme/' . C('CURRENT_THEME') . '/Site/Site/theme/' . $theme_info['name'] . '/header.html');
            $this->assign('theme_path_footer', './Theme/' . C('CURRENT_THEME') . '/Site/Site/theme/' . $theme_info['name'] . '/footer.html');
            $this->display('Site/theme/' . $theme_info['name'] . '/' . ($category_info['list_template'] ?: 'lists_page'));
        } else {
            // 主题目录
            $info['theme_path'] = __ROOT__ . '/Application/Site/View/Site/theme/' . $theme_info['name'];
            $this->assign('info', $info);
