        ...
        $(function(){
            $('input[name="type"]').change(function() {
                ...
                if (type == 'link') {
                    ...
                    $('.item_list_template').addClass('hidden');
                ...
                // 文章列表类型
                    ...
                    $('.item_content').addClass('hidden');
                    $('.item_module_name').addClass('hidden');
                    $('.item_list_template').removeClass('hidden');
                    $('.item_detail_template').removeClass('hidden');
                } else {
                    $('.item_url').addClass('hidden');
                    $('.item_content').addClass('hidden');
    ...
    public function add($group)
    {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle('新增导航') // 设置页面标题
                ...
                ->addFormItem('list_template', 'select', '列表模版', '文档列表模版', $template_list_index, 'hidden')
    ...
    public function edit($id, $group)
    {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle('编辑导航') // 设置页面标题
                ...
                ->addFormItem('target', 'radio', '打开方式', '打开方式', array('' => '当前窗口', '_blank' => '新窗口打开'))
                ->addFormItem('list_template', 'select', '列表模版', '文档列表模版', $template_list_index, $info['type'] === 'post' ? '' : 'hidden')
